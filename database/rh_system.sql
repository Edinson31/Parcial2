...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2026 a las 05:46:20
...
CREATE TABLE `aspirantes` (
  ...
  `estado` enum('no revisado','no considerado','considerado') DEFAULT 'no revisado',
...
--
ALTER TABLE `aspirantes`
  ADD CONSTRAINT `aspirantes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
COMMIT;
